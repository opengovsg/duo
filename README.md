...
```bash
docker run -d -p 27017:27017 --name mongo-duo mongo:latest
```
...
- `PUBLIC_APP_ASSETS` Is used to find logos & favicons in `static/$PUBLIC_APP_ASSETS`, current options are `duo`.
